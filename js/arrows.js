...
function drawFinalVector() {
  ...
  for (var i = 1; i < arrowList.length; i++) {
    ...
    currentArrow.attrs.points[2] = 
      finalArrow.attrs.points[2] - (arrowList[i].attrs.points[0] - arrowList[i].attrs.points[2]);

    currentArrow.attrs.points[3] =
      finalArrow.attrs.points[3] - (arrowList[i].attrs.points[1] - arrowList[i].attrs.points[3]);
